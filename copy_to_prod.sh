...
rsync -amv --exclude='.git/' --exclude='*.sh' --exclude='Dockerfile' --exclude='.dockerignore' --exclude='*.md' --exclude='endpoint.js' ../FlaskMinimalWebapp_dev/ ../FlaskMinimalWebapp_prod/
